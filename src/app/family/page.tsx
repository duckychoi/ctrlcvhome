  ...
  master: [
    {
      ...
      nameKr: '연승빈',
      role: 'Master Student',
      research: 'Drone Autonomy, Legged Robot Reinforcement Learning, Sim-to-Real Transfer',
  ...
  undergraduate: [
    {
      ...
      research: 'SLAM for Legged Robot, Agentic Locomotion, Embodied AI',
    ...
    },
    {
      ...
      nameKr: '김민재',
      role: 'Undergraduate Student',
      research: 'Vision AI System Automation, Deep Learning Pipeline Optimization',
      image: '/figure/family/김민재.png',
    },
    {
      name: 'Oh Ju Hyun',
      nameKr: '오주현',
    ...
    },
    {
      ...
      nameKr: '임영래',
      role: 'Undergraduate Student',
      research: 'VLA for Robot Arm, Imitation Learning, Embodied AI',
      image: '/figure/family/임영래.jpg',
    },
    {
      name: 'Choi Woo Seok',
      nameKr: '최우석',
